...
//!
//! This module intentionally has no Octoscript-callable API. A host configures an
...
use octoscript_protocol::{CapabilityGrant, ProtocolError, ResourceKind, ResourceSelector};
...
impl SecretAccessBinding {
    ...
    /// make the identifier discoverable from Octoscript source or worker protocol
    /// diagnostics.
