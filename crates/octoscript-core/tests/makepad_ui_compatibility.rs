use octoscript_core::{check_syntax, check_vm_compatibility_named, ExecutionLimits};

const MAKEPAD_UI_COUNTER: &str = include_str!("../../../examples/makepad_ui_counter.octoscript");

#[test]
fn makepad_ui_counter_is_accepted_by_the_bounded_vm_compatibility_check() {
    let report = check_vm_compatibility_named(
        "examples/makepad_ui_counter.octoscript",
        MAKEPAD_UI_COUNTER,
