...
/// invocation.
///
/// This value is not exposed to Octoscript source. It bounds the period from a
...
/// supervisor.
///
/// The wrapper is deliberately host-only. It never lets Octoscript source choose
...
/// `ProtocolWorkerClient` intentionally maps this to a generic Octoscript tool
