...
const ROOT_ENV: &str = "OCTOSCRIPT_PROJECT_QUOTA_TEST_ROOT";
const PROJECT_ID_ENV: &str = "OCTOSCRIPT_PROJECT_QUOTA_TEST_ID";
const MAXIMUM_BYTES_ENV: &str = "OCTOSCRIPT_PROJECT_QUOTA_TEST_MAXIMUM_BYTES";
const MAXIMUM_INODES_ENV: &str = "OCTOSCRIPT_PROJECT_QUOTA_TEST_MAXIMUM_INODES";
