...
//! Host-only authenticated durable-record boundary for Octoscript.
//!
//! Octoscript source never receives a storage handle or a key. Hosts inject a
...
fn authenticated_record_tag(
    ...
    hasher.update(b"octoscript-storage-record-v1");
