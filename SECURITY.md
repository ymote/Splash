...
secret storage, worker-process isolation, signed packages, structured tool
schemas, or mobile policy backends. Those features must not be inferred from
the presence of the VM.
